...
const Terms = () => {
  return (
    <div className="p-4">
      ...
      <p className="mb-4">Welcome to The Millet Store!</p>
      ...
      <p className="mb-4">
        ...
        conditions. Do not continue to use The Millet Store if you do not agree
      ...
      <p className="mb-4">
        Unless otherwise stated, Thirumathi Herbal & Natural Products and/or its
      ...
      <ul className="list-disc pl-8 mb-4">
        <li>Republish material from The Millet Store</li>
        <li>Sell, rent or sub-license material from The Millet Store</li>
        <li>Reproduce, duplicate or copy material from The Millet Store</li>
        <li>Redistribute content from The Millet Store</li>
      </ul>

      <p className="mb-4">
        Parts of this website offer an opportunity for users to post and
        exchange opinions and information in certain areas of the website.
        Thirumathi Herbal & Natural Products does not filter, edit, publish or
        review Comments prior to their presence on the website. Comments do not
        reflect the views and opinions of Thirumathi Herbal & Natural Products,
      ...
      <h1 className="text-xl font-bold mb-4">Hyperlinking to our Content</h1>
      <p className="mb-4">
